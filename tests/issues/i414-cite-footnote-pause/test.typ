...
// A footnote placed after `#pause` must stay hidden on the earlier subslides,
// whether it is a literal `#footnote` or a note-style citation (which renders as
// a footnote). Each slide's first subslide shows no footnote; it appears once
// revealed.
//
// #399 fixed the literal case; the note-style citation survived it (#414).
#show: simple-theme
