...
#context {
  ...
  //should be visible as it's a normal use case
  assert.eq(query(label("article-bare-visible")).len(), 1)
  //same as first two sections
  ...
  //last one should be there 2 times: once normally, once recalled
