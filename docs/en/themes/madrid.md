...
- `navigation-symbols`: Whether to show navigation symbols above the footer on the right, default is `false`.
...
- `#new-section-slide(config: (:), level: 1, body)`: Slide separating major sections.
